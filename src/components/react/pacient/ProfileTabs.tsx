        ...
        <dialog open className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 overflow-y-auto w-full h-full border-none">
          <section className="bg-white rounded-[2.5rem] w-full max-w-xl shadow-2xl relative animate-in zoom-in-95 duration-200 my-8 overflow-hidden">
            ...
            <form className="p-8 space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <input id="email" type="email" defaultValue="pedro.sanchez@gmail.com" className="w-full bg-white border border-slate-200 p-3 rounded-xl text-sm outline-none focus:ring-2 ring-blue-500" />
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <input id="phone" type="text" defaultValue="+58 412-1234567" className="w-full bg-white border border-slate-200 p-3 rounded-xl text-sm outline-none focus:ring-2 ring-blue-500" />
                  ...
                  <div className="md:col-span-2 space-y-1">
                    ...
                    <div className="relative">
                      <input id="address" type="text" defaultValue="Pueblo Nuevo, Edificio Sol, Apto 4B." className="w-full bg-white border border-slate-200 p-3 rounded-xl text-sm outline-none focus:ring-2 ring-blue-500" />
              ...
              <StaticCard className="p-6">
                <legend className="text-xs font-black text-red-500 uppercase tracking-widest flex items-center gap-2 mb-4">
                  <ShieldAlert className="w-4 h-4 text-red-500" /> Contacto de Emergencia
                </legend>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <input id="emergency-name" type="text" defaultValue="María Rodríguez" className="w-full bg-white border border-slate-200 p-3 rounded-xl text-sm outline-none focus:ring-2 ring-blue-500" />
                  ...
                  <div className="space-y-1">
                    ...
                    <select id="relation" className="w-full bg-white border border-slate-200 p-3 rounded-xl text-sm outline-none focus:ring-2 ring-blue-500 appearance-none">
