          ...
          <section className="bg-white rounded-[2.5rem] w-full max-w-2xl shadow-2xl relative animate-in zoom-in-95 duration-200 my-8 overflow-hidden">
            ...
            <header className="p-8 pb-4 flex justify-between items-start">
              <div>
                ...
                <p className="text-slate-500 text-sm font-medium">Actualiza tu información de contacto y seguridad.</p>
              </div>
              <button
              ...
              <StaticCard className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select className="w-full bg-white border border-slate-200 p-3 rounded-xl text-sm outline-none focus:ring-2 ring-primary-500 appearance-none">
